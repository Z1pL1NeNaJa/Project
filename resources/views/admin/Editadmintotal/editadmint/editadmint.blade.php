                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                            <h6 class="m-0 font-semibold text-gray-700 dark:text-gray-200">แก้ไขข้อมูลหน้า TYPEPRODUCT</h6>
                                        </div>
                                        ...
                                        <a href="{{asset('TypeProductfrom')}}" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">BACK</a>
                    </form>
                </div>
        </div>
