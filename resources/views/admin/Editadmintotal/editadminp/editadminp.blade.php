        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <form action="{{url('/productfrom/update/'.$editproduct->id_product)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Cards -->
                                            ...
                                            <form action="{{url('/productfrom/update/'.$editproduct->id_product)}}">
                                                ...
                                                <div class="form-group">
                                                    <label class="block text-sm">
                                                        ...
                                                        <input name="image" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="{{$editproduct->image}}" type="file" id="image" />
                                                        <img id="showImage" scr="{{asset('admin/images/'.$editproduct->image)}}" alt="">
                                                    </label>
                                                    <!--แสดงรูปภาพ-->
                                                    @error('image')
                                                    <span class="text-xs text-red-600 dark:text-red-400">{{$message}}</span>
                                                ...
                                                <!--<div class="form-group">
                                                    <label class="block text-sm">
                                                        ...
                                                        <input name="category" type="category" id="category" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="{{$editproduct->category_id}}" />
                                                    </label>
                                                    @error('category')
