    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
          ...
          <form action="{{route('create.b')}}" method="POST">
            {{csrf_field()}}
            <!-- Cards -->
            <div class="card mb-4">
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-semibold text-gray-700 dark:text-gray-200">เพิ่มข้อมูลหน้า BACKGOUND</h6>
              </div>
              <div class="">
                <form>
                  <div class="form-group">
                    <label class="block text-sm">
                      ...
                      <input name="name" id="name" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="กรอกข้อมูล" />
                    </label>
                    @error('name')
