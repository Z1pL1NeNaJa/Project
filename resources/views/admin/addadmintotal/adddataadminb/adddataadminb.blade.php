        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <form action="{{ route('create.b') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <!-- Cards -->
                        <div class="card mb-4">
                            ...
                            <div class="">
                                    <div class="form-group">
                                        ...
                                        @error('name')
                                            <span
                                                class="font-semibold text-3xl text-red-600 dark:text-red-400">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <label class="block text-sm">
                            ...
                            <a href="{{ asset('Backgroundfrom') }}"
                                class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">BACK</a>
                    </form>
                </div>
        </div>
