              ...
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-xs">
                      <img src="{{asset('admin/images/'.$products->image)}}" alt="" loading="lazy" style="width: 100px;" />
                    </td>
                    <td class="px-4 py-3 text-xs">
                      <span class="">
                        {{$products->price}}
                    ...
                    <td>
                      <a href="{{url('/productfrom/edit/'.$products->id_product)}}" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">EDIT</a>
                      <a href="{{url('/productfrom/delete/'.$products->id_product)}}" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red">
                        DELETE
                      </a>
                      @endforeach
            </div>
